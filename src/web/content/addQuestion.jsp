...
<form action="<c:url value="/addQuestion.html"/>" method="post">
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                <label for="question">Question</label>
                <textarea class="form-control" rows="9" id="question" name="content" placeholder="Question"></textarea>
            </div>
            <div class="form-group">
                <label for="knowledge">Knowledge</label>
                <input type="password" class="form-control" name="knowledge" id="knowledge" placeholder="Knowledge">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
